...
def _extrapolate_to_dem_bounds(line, dem_path, snap_tol=50.0, log_fn=print):
    ...
    bounding box.  Using nearest-boundary (not terminal-direction ray) avoids
    landing on the wrong edge when the last NHD segment is angled away from the
    river's actual exit boundary.
    """
