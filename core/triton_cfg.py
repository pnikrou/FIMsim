...
def create_triton_cfg(
    ...
    *,
    ...
    extbc_filename = ctx.get("triton_extbc_filename") or f"{project_name}.extbc"
    ...
    src_loc_filename = ctx.get("triton_src_loc_filename") or f"{project_name}_inflow_loc.txt"
    ...
    friction_asc = triton_dir / f"{project_name}.asc"
    ...
    if not output_folder:
        output_folder = f"output_{project_name}"
    ...
    lines = [
        "#---------------------------------------------------------------------------",
        f"# TRITON config file — {project_name}",
        "# Generated by TRITON Prep App",
        "#---------------------------------------------------------------------------",
        "# Input Data",
        "#---------------------------------------------------------------------------",
        "# Topography",
    ...
    # ── Write cfg ─────────────────────────────────────────────────────────────
    cfg_filename = cfg_filename or f"{project_name}.cfg"
