"""Per-AOI TRITON config card — collapsible accordion row (like AOIPARCard)."""
...
class AOITritonCfgCard(QFrame):
    ...
    def _build_ui(self):
        ...
        self._panel = TritonCfgConfigPanel(self)
    ...
    def panel(self) -> TritonCfgConfigPanel:
        return self._panel
