...
class StepTritonAOIWidget(QWidget):
    ...
    def __init__(self, log_fn, model: str = "lisflood", parent=None):
        ...
        # TRITON runs on a rectangular raster domain, so an irregular uploaded
        # AOI is replaced by its bounding-box rectangle for every downstream
        # step (the original is kept and shown in the preview).
