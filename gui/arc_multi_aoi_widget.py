...
class MultiAOIWidget(QWidget):
    ...
    def __init__(self, log_fn, parent=None, rectangularize: bool = False):
        """``rectangularize``: when True (ARC-Curve2Flood), any confirmed AOI that is
    ...
    def _confirm(self):
        ...
        # ARC-Curve2Flood: ARC-Curve2Flood builds its rating curves on rectangular DEM tiles.  Replace any irregular polygon
